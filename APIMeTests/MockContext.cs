...
namespace APIMeTests
{
    public class MockContext<T>
    {
        public APIMeContext GetMockContext()
        {
            ...
            context.Professors.Add(new Professor { Id = 1, Email = "testingmockup", FirstName = "first", LastName = "last" });
            ...
            context.Students.Add(new Student { Id = 1, FirstName = "test", LastName = "test", StudentId = 1234568, Email = "testingmockup", ApiKey = "t" });
